...
cat("\n","\n", "Random Forest", "\n", "\n")
# Verificar si hay valores faltantes en la variable Outcome
any(is.na(train$Outcome))

# Completar valores faltantes en Outcome (si es necesario)
train$Outcome[is.na(train$Outcome)] <- 0

# Convertir Outcome a numérico
...
# Obtener la media y la desviación estándar del error de predicción
mean_error_rf <- mean(cv_results$results$RMSE) # media del error de predicción
sd_error_rf <- sd(cv_results$results$RMSE) # desviación estándar del error de predicción
